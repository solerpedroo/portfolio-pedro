...
const translations = {
    pt: {
        ...
        'experience.job0.description': 'Estágio de Engenharia de Software na Nola: apoiei o desenvolvimento de sistemas e aplicações, com criação e manutenção de código, correção de falhas e melhoria contínua das soluções. Participei de testes para reforçar qualidade, desempenho e confiabilidade, em colaboração com a equipe técnica e boas práticas de desenvolvimento.',
        ...
        'experience.subskills': 'Contribuições principais',
        'experience.subcerts': 'Certificações relacionadas',
        'experience.job0.skill.1': 'Desenvolvimento e manutenção de aplicações web utilizando Vue.js e Nuxt.js',
        'experience.job0.skill.2': 'Implementação de funcionalidades e correção de bugs em ambiente de produção',
        'experience.job0.skill.3': 'Atuação em arquitetura serverless utilizando AWS e Serverless Framework',
        'experience.job0.skill.4': 'Desenvolvimento backend com Python e Django, integrando APIs e serviços',
        'experience.job0.skill.5': 'Gerenciamento e manipulação de dados com PostgreSQL',
        'experience.job0.skill.6': 'Utilização de Docker para padronização de ambientes e deploy',
        'experience.job0.skill.7': 'Participação em processos ágeis (Scrum/Kanban) com foco em entregas contínuas',
        'experience.job0.skill.8': 'Apoio em testes e validação de performance, garantindo qualidade e estabilidade',
        'experience.job0.skill.9': 'Contato com conceitos de Inteligência Artificial e Model Context Protocol (MCP)',
        'experience.job0.skill.10': 'Desenvolvimento mobile com React Native e uso de Android SDK / Android Studio',
        'experience.job1.skill.1': 'Desenvolvimento e manutenção de websites institucionais e sistemas internos',
        'experience.job1.skill.2': 'Suporte técnico a usuários e resolução de problemas de infraestrutura',
        'experience.job1.skill.3': 'Gestão e atualização de redes sociais com foco em presença digital',
        'experience.job1.skill.4': 'Implementação de melhorias tecnológicas para otimização de processos internos',
        'experience.job2.skill.1': 'Criação e gestão de loja virtual no modelo dropshipping',
        'experience.job2.skill.2': 'Planejamento e execução de campanhas de marketing digital',
        'experience.job2.skill.3': 'Automação de processos de vendas e funil de conversão',
        'experience.job2.skill.4': 'Otimização de anúncios e estratégias para aumento de performance',
        ...
        'projects.mescla_invest.title': 'Mescla Invest',
        'projects.mescla_invest.desc': 'Mescla Invest é o Projeto Integrador III da PUC-Campinas: app mobile em Flutter que simula um ecossistema de investimento em startups com negociação de tokens digitais. Stack com Firebase (Auth, Firestore, Storage, Functions em Node.js/TypeScript) e integração de serviços para uma experiência próxima a produtos digitais reais.',
        'projects.codegraph.title': 'CodeGraph',
        'projects.codegraph.desc': 'Plataforma com IA que analisa repositórios do GitHub ou projetos locais, mapeia dependências entre arquivos, detecta ciclos arquiteturais e gera insights sobre a estrutura do sistema. Utiliza visualização interativa com React Flow e Dagre para transformar código em análises acionáveis. Acelera documentação, onboarding e manutenção de software.',
        'projects.eplexpress.title': 'EPL Express',
        'projects.eplexpress.desc': 'EPL Express é uma empresa de transporte e logística em Campinas/SP. Desenvolvi em Next.js o site institucional com apresentação de serviços, FAQ e captação via WhatsApp, além de duas plataformas internas: gestão de motoristas com acompanhamento de rotas e painel administrativo para coordenar operações e processos.',
        ...
        'projects.tags.nextjs': 'Next.js',
        'projects.tags.flutter': 'Flutter',
        'projects.tags.dart': 'Dart',
        'projects.tags.firebase': 'Firebase',
        'projects.tags.mobile': 'Mobile',
        'projects.tags.finance': 'Finanças',
        'projects.tags.logistics': 'Logística',
    ...
    en: {
        ...
        'experience.job0.company': 'Nola',
        'experience.job0.description': 'Software Engineering internship at Nola: I supported building and maintaining systems and applications—implementation, bug fixes, and continuous improvement. I helped with testing to strengthen quality, performance, and reliability, working with the technical team and solid development practices.',
        ...
        'experience.subskills': 'Key contributions',
        'experience.subcerts': 'Related certifications',
        'experience.job0.skill.1': 'Development and maintenance of web applications using Vue.js and Nuxt.js',
        'experience.job0.skill.2': 'Feature implementation and bug fixes in production environments',
        'experience.job0.skill.3': 'Serverless architecture with AWS and Serverless Framework',
        'experience.job0.skill.4': 'Backend development with Python and Django, integrating APIs and services',
        'experience.job0.skill.5': 'Data management and operations with PostgreSQL',
        'experience.job0.skill.6': 'Docker for environment standardization and deployment',
        'experience.job0.skill.7': 'Agile practices (Scrum/Kanban) focused on continuous delivery',
        'experience.job0.skill.8': 'Testing and performance validation to ensure quality and stability',
        'experience.job0.skill.9': 'Hands-on with AI concepts and Model Context Protocol (MCP)',
        'experience.job0.skill.10': 'Mobile development with React Native and Android SDK / Android Studio',
        'experience.job1.skill.1': 'Development and maintenance of institutional websites and internal systems',
        'experience.job1.skill.2': 'Technical support for users and infrastructure troubleshooting',
        'experience.job1.skill.3': 'Social media management and updates focused on digital presence',
        'experience.job1.skill.4': 'Technology improvements to optimize internal processes',
        'experience.job2.skill.1': 'Creation and management of a dropshipping e-commerce store',
        'experience.job2.skill.2': 'Planning and execution of digital marketing campaigns',
        'experience.job2.skill.3': 'Sales automation and conversion funnel optimization',
        'experience.job2.skill.4': 'Ad and strategy optimization to improve performance',
        ...
        'projects.mescla_invest.title': 'Mescla Invest',
        'projects.mescla_invest.desc': 'Mescla Invest is PUC-Campinas Integrator Project III: a Flutter mobile app that simulates a startup investment ecosystem with digital token trading. Built with Firebase (Auth, Firestore, Storage, Node.js/TypeScript Functions) and service integrations for a real-world digital product experience.',
        'projects.codegraph.title': 'CodeGraph',
        'projects.codegraph.desc': 'AI-powered platform that analyzes GitHub repositories or local projects, maps file dependencies, detects architectural cycles, and generates insights about system structure. Uses interactive visualization with React Flow and Dagre to turn code into actionable analysis. Speeds up documentation, onboarding, and software maintenance.',
        'projects.eplexpress.title': 'EPL Express',
        'projects.eplexpress.desc': 'For EPL Express, a transport and logistics company in Campinas, SP, I built with Next.js the institutional website with service showcase, FAQ, and WhatsApp lead capture, plus two internal platforms: driver management with route tracking and an admin dashboard to coordinate operations and processes.',
        'projects.pdfchatbot.title': 'PDF Chatbot',
        ...
        'projects.tags.logistics': 'Logistics',
    ...
    es: {
        ...
        'experience.job0.company': 'Nola',
        'experience.job0.description': 'Pasantía en Ingeniería de Software en Nola: apoyé el desarrollo de sistemas y aplicaciones, con implementación y mantenimiento de código, corrección de fallos y mejoras continuas. Participé en pruebas para reforzar calidad, rendimiento y confiabilidad, junto al equipo técnico y buenas prácticas de desarrollo.',
        ...
        'experience.subskills': 'Contribuciones principales',
        'experience.subcerts': 'Certificaciones relacionadas',
        'experience.job0.skill.1': 'Desarrollo y mantenimiento de aplicaciones web con Vue.js y Nuxt.js',
        'experience.job0.skill.2': 'Implementación de funcionalidades y corrección de errores en producción',
        'experience.job0.skill.3': 'Arquitectura serverless con AWS y Serverless Framework',
        'experience.job0.skill.4': 'Backend con Python y Django, integrando APIs y servicios',
        'experience.job0.skill.5': 'Gestión y manipulación de datos con PostgreSQL',
        'experience.job0.skill.6': 'Docker para estandarizar entornos y despliegue',
        'experience.job0.skill.7': 'Procesos ágiles (Scrum/Kanban) con enfoque en entregas continuas',
        'experience.job0.skill.8': 'Apoyo en pruebas y validación de rendimiento, calidad y estabilidad',
        'experience.job0.skill.9': 'Contacto con Inteligencia Artificial y Model Context Protocol (MCP)',
        'experience.job0.skill.10': 'Desarrollo móvil con React Native y Android SDK / Android Studio',
        'experience.job1.skill.1': 'Desarrollo y mantenimiento de sitios institucionales y sistemas internos',
        'experience.job1.skill.2': 'Soporte técnico a usuarios y resolución de problemas de infraestructura',
        'experience.job1.skill.3': 'Gestión y actualización de redes sociales con foco en presencia digital',
        'experience.job1.skill.4': 'Mejoras tecnológicas para optimizar procesos internos',
        'experience.job2.skill.1': 'Creación y gestión de tienda virtual en modelo dropshipping',
        'experience.job2.skill.2': 'Planificación y ejecución de campañas de marketing digital',
        'experience.job2.skill.3': 'Automatización de ventas y embudo de conversión',
        'experience.job2.skill.4': 'Optimización de anuncios y estrategias para mejorar resultados',
        ...
        'projects.mescla_invest.title': 'Mescla Invest',
        'projects.mescla_invest.desc': 'Mescla Invest es el Proyecto Integrador III de PUC-Campinas: aplicación móvil en Flutter que simula un ecosistema de inversión en startups con negociación de tokens digitales. Stack con Firebase (Auth, Firestore, Storage, Functions en Node.js/TypeScript) e integración de servicios para una experiencia cercana a productos digitales reales.',
        'projects.codegraph.title': 'CodeGraph',
        'projects.codegraph.desc': 'Plataforma con IA que analiza repositorios de GitHub o proyectos locales, mapea dependencias entre archivos, detecta ciclos arquitectónicos y genera insights sobre la estructura del sistema. Utiliza visualización interactiva con React Flow y Dagre para transformar código en análisis accionables. Acelera documentación, incorporación y mantenimiento de software.',
        'projects.eplexpress.title': 'EPL Express',
        'projects.eplexpress.desc': 'Para EPL Express, empresa de transporte y logística en Campinas/SP, desarrollé en Next.js el sitio institucional con servicios, FAQ y captación por WhatsApp, además de dos plataformas internas: gestión de conductores con seguimiento de rutas y panel administrativo para coordinar operaciones y procesos.',
        'projects.pdfchatbot.title': 'PDF Chatbot',
