...
const translations = {
    pt: {
        ...
        'skills.soft.programming': 'Programação e stack: C, C++, CSS, Dart, Flutter, Firebase, HTML, JavaScript, TypeScript, Node.js, Vue.js, Nuxt.js, Python, Django, React Native, MySQL, PostgreSQL, Supabase, AWS, Serverless Framework, Docker, Android SDK, Android Studio',
        'skills.soft.cnn': 'Redes neurais convolucionais (CNN)',
        'skills.soft.yolo': 'YOLO — detecção e rastreamento de objetos',
        'skills.soft.generative-ai': 'Inteligência artificial generativa',
        'skills.soft.mcps': 'Model Context Protocol (MCPs)',
    ...
    en: {
        ...
        'skills.soft.programming': 'Programming & stack: C, C++, CSS, Dart, Flutter, Firebase, HTML, JavaScript, TypeScript, Node.js, Vue.js, Nuxt.js, Python, Django, React Native, MySQL, PostgreSQL, Supabase, AWS, Serverless Framework, Docker, Android SDK, Android Studio',
        'skills.soft.cnn': 'Convolutional neural networks (CNN)',
        'skills.soft.yolo': 'YOLO — object detection and tracking',
        'skills.soft.generative-ai': 'Generative artificial intelligence',
        'skills.soft.mcps': 'Model Context Protocol (MCPs)',
        'skills.soft.social-media': 'Social Media',
    ...
    es: {
        ...
        'skills.soft.design-thinking': 'Design Thinking',
        'skills.soft.software-dev': 'Desarrollo de software',
        ...
        'skills.soft.programming': 'Programación y stack: C, C++, CSS, Dart, Flutter, Firebase, HTML, JavaScript, TypeScript, Node.js, Vue.js, Nuxt.js, Python, Django, React Native, MySQL, PostgreSQL, Supabase, AWS, Serverless Framework, Docker, Android SDK, Android Studio',
        'skills.soft.cnn': 'Redes neuronales convolucionales (CNN)',
        'skills.soft.yolo': 'YOLO — detección y seguimiento de objetos',
        'skills.soft.generative-ai': 'Inteligencia artificial generativa',
        'skills.soft.mcps': 'Model Context Protocol (MCPs)',
        ...
        'skills.soft.computer-vision': 'Visión por computadora',
        ...
        'cert.2.title': 'Análisis de métricas para comercio electrónico', 'cert.2.inst': 'Alura',
        'cert.3.title': 'Análisis y clasificación de rostros', 'cert.3.inst': 'Alura',
        'cert.4.title': 'Aprendizaje con IA: ChatGPT', 'cert.4.inst': 'Alura',
        'cert.5.title': 'Asistente en desarrollo de aplicaciones', 'cert.5.inst': 'Senac Campinas',
        'cert.6.title': 'Asistente en operación de redes', 'cert.6.inst': 'Senac Campinas',
        'cert.7.title': 'Asistente en soporte y mantenimiento', 'cert.7.inst': 'Senac Campinas',
        'cert.8.title': 'Clase magistral con Caito Maia - Branding', 'cert.8.inst': 'Belas Artes y Chilli Beans',
        'cert.9.title': 'Branding: creación de una marca sólida', 'cert.9.inst': 'Alura',
        'cert.10.title': 'Fundamentos de Facebook Ads', 'cert.10.inst': 'Bequest Digital',
        'cert.11.title': 'Canva: presentaciones comerciales', 'cert.11.inst': 'Alura',
        'cert.12.title': 'Canva: videos con motion graphics', 'cert.12.inst': 'Alura',
        'cert.13.title': 'Canva: diseños digitales para redes sociales', 'cert.13.inst': 'Alura',
        'cert.14.title': 'Canva: crea un libro electrónico con IA', 'cert.14.inst': 'Alura',
        'cert.15.title': 'CashFlow', 'cert.15.inst': 'Bequest Digital',
        'cert.16.title': 'ChatGPT: descubriendo la IA', 'cert.16.inst': 'Alura',
        'cert.17.title': 'ChatGPT: optimización de resultados', 'cert.17.inst': 'Alura',
        'cert.18.title': 'Comunicación corporativa: PowerPoint', 'cert.18.inst': 'Alura',
        'cert.19.title': 'Construcción de tiendas profesionales', 'cert.19.inst': 'Bequest Digital',
        'cert.20.title': 'Copywriting y persuasión', 'cert.20.inst': 'Bequest Digital',
        'cert.21.title': 'Copywriting: textos persuasivos con IA', 'cert.21.inst': 'Alura',
        'cert.22.title': 'Creatividades que venden', 'cert.22.inst': 'Bequest Digital',
        'cert.23.title': 'Creación de contenido en video', 'cert.23.inst': 'Alura',
        'cert.24.title': 'Desarrolla tu primer chatbot', 'cert.24.inst': 'IBM',
        'cert.25.title': 'Diseño de presentaciones: PowerPoint', 'cert.25.inst': 'Alura',
        'cert.26.title': 'Design Thinking', 'cert.26.inst': 'Sebrae',
        'cert.27.title': 'Estrategia de crecimiento para startups', 'cert.27.inst': 'SantaderX',
        'cert.28.title': 'Excel: domina el editor de hojas de cálculo', 'cert.28.inst': 'Alura',
        'cert.29.title': 'Facebook Ads: campaña de video', 'cert.29.inst': 'Alura',
        ...
        'cert.32.title': 'Facebook Ads: campañas exitosas', 'cert.32.inst': 'Alura',
        'cert.33.title': 'Embudos de ventas que generan resultados', 'cert.33.inst': 'Bequest Digital',
        'cert.34.title': 'Excel: funciones y operaciones matemáticas', 'cert.34.inst': 'Alura',
        'cert.35.title': 'Gestión del conocimiento con IA', 'cert.35.inst': 'Alura',
        'cert.36.title': 'Gestión financiera', 'cert.36.inst': 'Sebrae',
        'cert.37.title': 'Gestión financiera: administra tus finanzas', 'cert.37.inst': 'Alura',
        'cert.38.title': 'Inteligencia artificial: marketing digital', 'cert.38.inst': 'Alura',
        'cert.39.title': 'Inteligencia artificial: gestión de redes sociales', 'cert.39.inst': 'Alura',
        'cert.40.title': 'Inteligencia artificial: estrategias de ventas', 'cert.40.inst': 'Alura',
        'cert.41.title': 'Inteligencia artificial generativa', 'cert.41.inst': 'Alura',
        'cert.42.title': 'Marketing digital: explorando conceptos', 'cert.42.inst': 'Alura',
        'cert.43.title': 'Marketing digital para tu empresa', 'cert.43.inst': 'Alura',
        'cert.44.title': 'Redes sociales: estrategias de engagement', 'cert.44.inst': 'Alura',
        'cert.45.title': 'Cambios y decisiones', 'cert.45.inst': 'Sebrae',
        'cert.46.title': '¿Qué es el email marketing?', 'cert.46.inst': 'Bequest Digital',
        'cert.47.title': 'Taller de emprendimiento', 'cert.47.inst': 'PUC-Campinas',
        'cert.48.title': 'Planificación estratégica', 'cert.48.inst': 'G4 Educação',
        'cert.49.title': 'Plan de marketing digital', 'cert.49.inst': 'Alura',
        'cert.50.title': 'Productos, abastecimiento y suministro', 'cert.50.inst': 'Bequest Digital',
        'cert.51.title': 'Psicología financiera', 'cert.51.inst': 'Alura',
        'cert.52.title': 'Python: primeros pasos con el lenguaje', 'cert.52.inst': 'Alura',
        'cert.53.title': 'Página de ventas y oferta', 'cert.53.inst': 'Bequest Digital',
        'cert.54.title': 'Excel: recursos visuales', 'cert.54.inst': 'Alura',
        'cert.55.title': 'Seminario La universidad del futuro', 'cert.55.inst': 'PUC-Campinas',
        'cert.56.title': 'Social commerce', 'cert.56.inst': 'Alura',
        'cert.57.title': 'Storytelling como herramienta de negocio', 'cert.57.inst': 'Sebrae',
        'cert.58.title': 'Tecnologías de la información', 'cert.58.inst': 'iEstudar',
        'cert.59.title': 'Pruebas en Facebook Ads', 'cert.59.inst': 'Bequest Digital',
        'cert.60.title': 'TikTok Ads: funciones y configuración', 'cert.60.inst': 'Alura',
        'cert.61.title': 'Tráfico de pago: estrategias y aplicaciones', 'cert.61.inst': 'Alura',
        'cert.62.title': 'Uso de IA generativa para desarrollo', 'cert.62.inst': 'IBM',
        ...
        'cert.65.title': 'Taller de argumentación', 'cert.65.inst': 'PUC-Campinas',
        'cert.66.title': 'Taller de modelado de negocio', 'cert.66.inst': 'Inova Unicamp',
        'cert.67.title': 'Taller de descubrimiento del cliente ideal', 'cert.67.inst': 'Inova Unicamp',
