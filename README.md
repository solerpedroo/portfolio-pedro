...
4. **Adicione** suas próprias imagens na pasta `img/`
5. **Substitua** os PDFs do currículo na pasta `cv/`
...
2. Inclua os estilos CSS correspondentes
3. Adicione as traduções no JavaScript
4. Atualize o menu de navegação
...
Este projeto é de uso pessoal e educacional. Sinta-se livre para usar como base para seu próprio portfólio.
